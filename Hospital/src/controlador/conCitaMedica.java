...
public class conCitaMedica implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vistaCitaMedica.btnActualizar) {
            // Capturar valores
            int codigo = Integer.parseInt(vistaCitaMedica.txtCodigo.getText());
            String motivo = vistaCitaMedica.txtMotivo.getText();
            String diagnostico = vistaCitaMedica.txtDiagnostico.getText();
            ...
            String respuesta = modeloCitaMedica.updateCitaMedica(codigo, motivo, diagnostico, concepto, medicina, fecha, paciente, doctor);
            // Mostrar resultado
            JOptionPane.showMessageDialog(null, respuesta);
        }
        // Función para el botón Eliminar
        if (e.getSource() == vistaCitaMedica.btnEliminar) {
            // Capturar valores
            int codigo = Integer.parseInt(vistaCitaMedica.txtCodigo.getText());
            // Ejecutar la función DELETE
            String respuesta = modeloCitaMedica.deleteCitaMedica(codigo);
            // Mostrar resultado
